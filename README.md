...
애니메이션으로 재생됩니다. 점프는 기본 점프 후 한 번 더 사용할 수 있으며,
점프할 때마다 공중 대시가 다시 충전됩니다. 대시는 지상과 공중에서 사용할 수 있고, 공중에서는
한 번 사용하면 착지할 때까지 다시 충전되지 않습니다. 대시 중에는 중력이 멈추며
초반 0.16초 동안 무적 상태가 됩니다. 공중 공격은 연속으로 사용할수록 체공이
누적되며 최대 0.9초까지 공격 판정을 만든 뒤 다시 낙하합니다. 연속 입력 사이에도
체공이 끊기지 않도록 공격 간격을 여유 있게 유지합니다. 대시 키를 계속 누르면 대시 종료 후 달리기로
